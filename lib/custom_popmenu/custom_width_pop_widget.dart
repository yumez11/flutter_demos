...
// const double _kMenuMaxWidth = 5.0 * kMenuWidthStep;
// const double _kMenuMinWidth = 2.0 * kMenuWidthStep;
const double _kMenuVerticalPadding = 8.0;
// const double kMenuWidthStep = 26.0;
  ...
  Widget build(BuildContext context) {
    ...
    final Widget child = ConstrainedBox(
      constraints: BoxConstraints(
        ...
        maxWidth: (itemWidth ?? 20) * 2,
      ),
      child: IntrinsicWidth(
        stepWidth: itemWidth ?? 20,
        child: Semantics(
          scopesRoute: true,
          namesRoute: true,
  ...
  void showButtonMenu() {
    ...
    if (items.isNotEmpty) {
      showMenu<T?>(
        ...
        itemWidth: widget.menuItemWidth,
        items: items,
